...
title: "data.table"
description: |
  Importer formater et manipuler vos données: data.table vs tidyverse.
author:
...
knitr::opts_knit$set(root.dir='C:/Users/plasserre/Documents/R_workshops/codons.netlify/_posts/datatable/')
```
...
```{r, layout="l-body"}
knitr::include_graphics("img/logo_datatable.png")
```
...
**8. [FORMATAGE DES DONNEES](#lapply)**: [Rbase](#Rbase5), [tydiverse](#tidyverse5), [data.table](#data.table5)

<br>

# 1-IMPORT DE TABLES FORMAT LONG: readr vs fread {#long}
...
# 2-CALCULS SUR LES COLONNES {#calculs}
...
# 4-SELECTIONNER DES COLONNES {#select}

## tydiverse {#tidyverse1}
...
# 7-IMPORT DE TABLE FORMAT LARGE {#wide}
...
# 8-FORMATAGE DES DONNEES {#lapply}
